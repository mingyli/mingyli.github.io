...
Recall from the definition of a tree that it is
connected and acyclic, meaning there exists exactly
one path between any two vertices in the spanning tree.
...
1. Select arbitrary vertex $$ v_0 $$ and initialize tree $$ T = \{ v_0 \} $$
2. While $$ T $$ does not span $$ G $$
...
This is known as the Chow-Liu algorithm and produces
